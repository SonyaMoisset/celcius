...
/***/ function(module, exports, __webpack_require__) {
	...
	var _WeatherApp = __webpack_require__(167);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeatherApp = function (_React$Component) {
	  ...
	  function WeatherApp() {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(WeatherApp).call(this));

	    _this.state = {
	      city: 'Waiting for geolocation data...',
	      country: 'Loading...',
	  ...
	  _createClass(WeatherApp, [{
	    ...
	    value: function fetchWeather(units) {
	      ...
	      (0, _api.getLocationCoords)().then(function (coords) {
	        (0, _api.getWeatherData)(units, coords).then(function (weatherData) {
	          _this2.setState({
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'span',
	              { className: 'super-small', onClick: this.fetchWeather.bind(this, this.state.availableUnit) },
	              '/ ',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _superagentJsonp = __webpack_require__(175);
